...
const Tab: React.FC<TabProps> = ({
	...
	return (
		<div
			...
			className={
				'min-w-[9rem] h-10 border-x-[0.5px] border-lining p-2 text-sm hover:cursor-pointer hover:bg-base_white flex flex-row items-center justify-between align-middle z-20 ' +
