...
const IconCircleButton: React.FC<NodeButtonProps> = ({
  ...
  const icons: { [key: string]: JSX.Element } = {
    ...
    expand: (
      <ArrowsAngleExpand color={!selected ? color : 'white'} size={iconSize} />
    ),
    remove: <Trash color={!selected ? color : 'white'} size={iconSize} />,
    connection: (
      <Connectdevelop color={!selected ? color : 'white'} size={iconSize} />
    ),
    close: <CloseOutline color={!selected ? color : 'white'} size={iconSize} />,
    block: <Cube size={'1em'} color={!selected ? color : 'white'} />,
    graph: <CircularGraph size={'1em'} color={!selected ? color : 'white'} />,
    angleRight: <AngleRight size={'1em'} color={!selected ? color : 'white'} />,
    angleLeft: <AngleLeft size={'1em'} color={!selected ? color : 'white'} />,
    angleDown: <AngleDown size={'1em'} color={!selected ? color : 'white'} />,
    save: <Save size={'1em'} color={!selected ? color : 'white'} />,
    data: <Data size={'1em'} color={!selected ? color : 'white'} />,
    algo: <Thealgorithms size={'1em'} color={!selected ? color : 'white'} />,
    checklist: (
    ...
    menu: <MenuOutline size={iconSize} color={!selected ? color : 'white'} />,
    settings: <Settings size={iconSize} color={!selected ? color : 'white'} />,
