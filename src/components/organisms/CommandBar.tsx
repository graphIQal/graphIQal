...
const CommandBar: React.FC = () => {
  ...
  const { nodeData_Graph, nodeVisualData_Graph, addAction, graphViewId } =
    useGraphViewData();
  ...
  const commandBarShortcutConfig = {
    code: 'KeyP',
    ctrlKey: true,
  };

  useKeyboardShortcut(down, commandBarShortcutConfig);
            ...
            <CommandGroup heading='Nodes'>
              ...
              {results.map((node: any) => {
                return (
                  ...
                  >
                    <IconTitle title={node.n.title} icon={node.n.icon} />
                    <div>
                      <IconCircleButton
                        src='navigation'
                        circle={false}
