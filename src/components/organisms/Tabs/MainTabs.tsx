...
const MainTabs: React.FC<MainTabsProps> = ({
  ...
  } = useSWR([nodeId ? `/api/username/${nodeId}` : null], fetcherSingleReturn, {
            ...
            if (
              ...
              if (
                ...
                const newData = {
                  n: {
                    ...favData.n,
                    favourites: [...favData.n.favourites, nodeId],
                  },
                  connectedNodes: [
                    ...favData.connectedNodes,
                    {
        ...
        <div className='w-screen h-10 bg-blue-50'>
          <Tabs mutateGraphViews={mutateGraphViews}>
            {mainViewTabs.map((tab, index) => {
              if (index === 0 && nodeDataSWR) tab.title = nodeDataSWR.n.title;
              return (
                <div key={index}>
                  <Link
                    href={{
