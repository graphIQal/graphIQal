...
const Xarrow: React.FC<xarrowPropsType> = (props: xarrowPropsType) => {
  ...
  useEffect(() => {
    const monitorDOMchanges = () => {
      ...
      if (lineDrawAnimRef.current && headRef.current) {
        ...
        lineDrawAnimRef.current.addEventListener(
          'beginEvent',
          handleDrawAmimBegin
        );
      }
  ...
  return (
    <div
      {...divContainerProps}
      style={{ position: 'absolute', zIndex, ...divContainerStyle }}
    >
      {showXarrow ? (
        <>
          <svg
            ...
            style={{
              ...
              top: st.cy0,
              pointerEvents: 'none',
              border: _debug ? '1px dashed yellow' : '0px',
              ...SVGcanvasStyle,
            }}
            overflow='auto'
            {...SVGcanvasProps}
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      width: 5,
                      position: 'absolute',
                      left: (p as any).x - st.mainDivPos.x,
                      top: (p as any).y - st.mainDivPos.y,
                    }}
                  />
                );
              })}
