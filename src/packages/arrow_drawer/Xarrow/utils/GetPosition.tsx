...
export const getPosition = (
  ...
  _headOffset = fHeadSize * headOffset;
  _tailOffset = fTailSize * tailOffset;
  ...
  if (path === 'smooth')
    ...
    curvesPossibilities = {
      hh: () => {
        ...
        if (showHead) {
          cpx1 -=
            ((fHeadSize * (1 - (headOffset == undefined ? 0 : headOffset))) /
              2) *
            xSign;
          cpx2 +=
            ((fHeadSize * (1 - (headOffset == undefined ? 0 : headOffset))) /
        ...
        if (showTail) {
          cpx1 -=
            ((fTailSize * (1 - (tailOffset == undefined ? 0 : tailOffset))) /
              2) *
            xSign;
          cpx2 +=
            ((fTailSize * (1 - (tailOffset == undefined ? 0 : tailOffset))) /
